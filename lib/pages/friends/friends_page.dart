...
import '../../pages/friends/index_bar.dart';

import '../../model/friends_data.dart';
...
class _FriendsPageState extends State<FriendsPage> with AutomaticKeepAliveClientMixin {
  ...
  final ScrollController _scrollController = ScrollController();  // 相当于iOS的scrollView
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (BuildContext ctx) => DiscoverChildPage(title: '添加好友')));
            },
            child: Container(
        ...
        title: Text('通讯录', style: TextStyle(color: Colors.black87)),
      ),
      body: Container(
        color: themeColor,
        child: Stack(
          children: [
            ...
            IndexBar(indexBarCallback: (String str) {
              print('点击了${str}');
              var offset = _groupOffsetMap[str];
              if (offset != null) {
